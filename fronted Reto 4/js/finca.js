...
function editar(id) {
  ...
  url = "http://144.24.17.60:8084/api/Boat";
...
function eliminar(id) {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  let url = "http://144.24.17.60:8084/api/Boat";
...
function guardarNuevo() {
  ...
  let addressFarm = document.getElementById("year").value;
  let exensionFarm = document.getElementById("brand").value;
  ...
  url = "http://144.24.17.60:8084/api/Boat/save";
...
function guardarEditar() {
  ...
  url = "http://144.24.17.60:8084/api/Boat/update";
