let url ="http://144.24.17.60:8084/api/Category/all";
...
function editar(id) {
  ...
  url ="http://144.24.17.60:8084/api/Category";
...
function guardarNuevo() {
  ...
  url = "http://144.24.17.60:8084/api/Category/save";         
...
function guardarEditar() {
  ...
  //convierto el objeto de javascript a formato json
  let objetoJson = JSON.stringify(objeto)
  url ="http://144.24.17.60:8084/api/Category/update";
