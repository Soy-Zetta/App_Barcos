...
function editar(id) {
  ...
  url = "http://144.24.17.60:8084/api/Client";
...
function guardarNuevo() {
  ...
  url = "http://144.24.17.60:8084/api/Client/save";
...
function guardarEditar() {
  ...
  url = "http://144.24.17.60:8084/api/Client/update"
...
function guardarBorrar() {
  ...
  let url = "http://144.24.17.60:8084/api/Client";
