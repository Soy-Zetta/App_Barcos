...
let url = "http://144.24.17.60:8084/api/Reservation/all"
...
function guardarNuevo() {
  ...
  let url ="http://144.24.17.60:8084/api/Reservation/save"
...
function traerdatos() {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://144.24.17.60:8084/api/Reservation/all"
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (let i in respuesta) {
        ...
        registros +=
          ...
          "</td>\
                        <td>" +
                        respuesta[i].boat.name + " - " + respuesta[i].boat.category.name +
          "</td>\
                        <td>" +
